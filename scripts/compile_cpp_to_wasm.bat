...
call em++ -std=c++17 -Os -flto lib.cpp -s ENVIRONMENT=web -s MODULARIZE -s EXPORT_ES6 -s EXPORTED_FUNCTIONS="['_malloc','_free']" -s EXPORTED_RUNTIME_METHODS="['HEAPF32']" -lembind -o ..\..\build\c++\lib.js
